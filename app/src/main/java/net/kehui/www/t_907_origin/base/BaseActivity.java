...
public class BaseActivity extends AppCompatActivity {
    ...
    public int[]    waveDraw;
    public int[]    waveDraw1;
    public int[]    waveDraw2;
    public int[]    waveDraw3;
    public int[]    waveDraw4;
    public int[]    waveCompare;
    /**
     * 不同范围和方式下，波形数据的点数、比例值、需要去掉的冗余点数
     */
    ...
    public final static int COMMAND_METHOD          = 0x02;
    ...
    public final static int GAIN_INCREASE   = 0x11;
    public final static int GAIN_REDUCE     = 0x22;
    public final static int DELAY_INCREASE  = 0x11;
    public final static int DELAY_REDUCE    = 0x22;
    public final static int BALANCE_INCREASE    = 0x11;
    public final static int BALANCE_REDUCE      = 0x22;
    ...
    public final static int WAVE_DATA_LENGTH = 0x04;
    ...
    private void initData() {
        ...
        waveDraw1   = new int[510];
        waveDraw2   = new int[510];
        waveDraw3   = new int[510];
        waveDraw4   = new int[510];
